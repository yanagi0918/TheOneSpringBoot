package com.theone.springboot.ecpay.payment.integration;
...
import com.theone.springboot.ecpay.payment.integration.domain.ATMRequestObj;
import com.theone.springboot.ecpay.payment.integration.domain.AioCheckOutALL;
import com.theone.springboot.ecpay.payment.integration.domain.AioCheckOutATM;
import com.theone.springboot.ecpay.payment.integration.domain.AioCheckOutBARCODE;
import com.theone.springboot.ecpay.payment.integration.domain.AioCheckOutCVS;
import com.theone.springboot.ecpay.payment.integration.domain.AioCheckOutDevide;
import com.theone.springboot.ecpay.payment.integration.domain.AioCheckOutOneTime;
import com.theone.springboot.ecpay.payment.integration.domain.AioCheckOutPeriod;
import com.theone.springboot.ecpay.payment.integration.domain.AioCheckOutWebATM;
import com.theone.springboot.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
import com.theone.springboot.ecpay.payment.integration.domain.CreateServerOrderObj;
import com.theone.springboot.ecpay.payment.integration.domain.DoActionObj;
import com.theone.springboot.ecpay.payment.integration.domain.FundingReconDetailObj;
import com.theone.springboot.ecpay.payment.integration.domain.InvoiceObj;
import com.theone.springboot.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import com.theone.springboot.ecpay.payment.integration.domain.QueryTradeInfoObj;
import com.theone.springboot.ecpay.payment.integration.domain.QueryTradeObj;
import com.theone.springboot.ecpay.payment.integration.domain.TradeNoAioObj;
import com.theone.springboot.ecpay.payment.integration.ecpayOperator.EcpayFunction;
import com.theone.springboot.ecpay.payment.integration.errorMsg.ErrorMessage;
import com.theone.springboot.ecpay.payment.integration.exception.EcpayException;
import com.theone.springboot.ecpay.payment.integration.verification.VerifyAioCheckOut;
import com.theone.springboot.ecpay.payment.integration.verification.VerifyCreateServerOrder;
import com.theone.springboot.ecpay.payment.integration.verification.VerifyDoAction;
import com.theone.springboot.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import com.theone.springboot.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
import com.theone.springboot.ecpay.payment.integration.verification.VerifyQueryTrade;
import com.theone.springboot.ecpay.payment.integration.verification.VerifyQueryTradeInfo;
import com.theone.springboot.ecpay.payment.integration.verification.VerifyTradeNoAio;
