package com.theone.springboot.ecpay.payment.integration.ecpayOperator;
...
public class PaymentVerifyBase{
	protected String confPath = "/com/theone/springboot/ecpay/payment/integration/config/EcpayPayment.xml";
